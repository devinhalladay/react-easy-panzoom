...
function (_React$Component) {
  ...
  function PanZoom() {
    ...
    _defineProperty(_assertThisInitialized(_this), "zooming", false);
    ...
    _defineProperty(_assertThisInitialized(_this), "onWheel", function (e) {
      ...
      var zoomEndCallback = function zoomEndCallback() {
        return _this.triggerOnZoomEnd(e);
      };

      window.clearTimeout(_this.zooming);
      _this.zooming = setTimeout(function () {
        // Run the callback
        zoomEndCallback(e);
        return;
      }, 20);
      ...
      _this.triggerOnZoom(e);

      e.preventDefault();
    });

    _defineProperty(_assertThisInitialized(_this), "triggerOnZoom", function (e) {
      var _this$props4 = _this.props,
          disableScrollZoom = _this$props4.disableScrollZoom,
          disabled = _this$props4.disabled,
          zoomSpeed = _this$props4.zoomSpeed,
    ...
    _defineProperty(_assertThisInitialized(_this), "triggerOnZoomEnd", function (e) {
      var _this$props5 = _this.props,
          disableScrollZoom = _this$props5.disableScrollZoom,
          disabled = _this$props5.disabled,
          onZoomEnd = _this$props5.onZoomEnd;
    ...
    _defineProperty(_assertThisInitialized(_this), "onKeyDown", function (e) {
      var _this$props6 = _this.props,
          keyMapping = _this$props6.keyMapping,
    ...
    _defineProperty(_assertThisInitialized(_this), "onTouchStart", function (e) {
      var _this$props8 = _this.props,
          preventPan = _this$props8.preventPan,
          onTouchStart = _this$props8.onTouchStart,
    ...
    _defineProperty(_assertThisInitialized(_this), "onToucheMove", function (e) {
      var _this$props9 = _this.props,
          realPinch = _this$props9.realPinch,
          noStateUpdate = _this$props9.noStateUpdate,
          zoomSpeed = _this$props9.zoomSpeed;
    ...
    _defineProperty(_assertThisInitialized(_this), "centeredZoom", function (delta, zoomSpeed) {
      ...
      var needle = 8;
      var closest = [1, 10, 7, 2, 4].reduce(function (a, b) {
  ...
  _createClass(PanZoom, [{
    ...
    value: function componentDidMount() {
      var _this$props13 = this.props,
          autoCenter = _this$props13.autoCenter,
          autoCenterZoomLevel = _this$props13.autoCenterZoomLevel,
          minZoom = _this$props13.minZoom,
          maxZoom = _this$props13.maxZoom;
    ...
    value: function render() {
      var _this$props14 = this.props,
          ...
          autoCenter = _this$props14.autoCenter,
          autoCenterZoomLevel = _this$props14.autoCenterZoomLevel,
          zoomSpeed = _this$props14.zoomSpeed,
          doubleZoomSpeed = _this$props14.doubleZoomSpeed,
          disabled = _this$props14.disabled,
          disableDoubleClickZoom = _this$props14.disableDoubleClickZoom,
          disableScrollZoom = _this$props14.disableScrollZoom,
          disableKeyInteraction = _this$props14.disableKeyInteraction,
          realPinch = _this$props14.realPinch,
          keyMapping = _this$props14.keyMapping,
          minZoom = _this$props14.minZoom,
          maxZoom = _this$props14.maxZoom,
          enableBoundingBox = _this$props14.enableBoundingBox,
          boundaryRatioVertical = _this$props14.boundaryRatioVertical,
          boundaryRatioHorizontal = _this$props14.boundaryRatioHorizontal,
          noStateUpdate = _this$props14.noStateUpdate,
          onPanStart = _this$props14.onPanStart,
          onPan = _this$props14.onPan,
          onPanEnd = _this$props14.onPanEnd,
          onZoom = _this$props14.onZoom,
          onZoomEnd = _this$props14.onZoomEnd,
          preventPan = _this$props14.preventPan,
          style = _this$props14.style,
          onDoubleClick = _this$props14.onDoubleClick,
          onMouseDown = _this$props14.onMouseDown,
          onKeyDown = _this$props14.onKeyDown,
          onKeyUp = _this$props14.onKeyUp,
          onTouchStart = _this$props14.onTouchStart,
          onStateChange = _this$props14.onStateChange,
          restPassThroughProps = _objectWithoutProperties(_this$props14, ["children", "autoCenter", "autoCenterZoomLevel", "zoomSpeed", "doubleZoomSpeed", "disabled", "disableDoubleClickZoom", "disableScrollZoom", "disableKeyInteraction", "realPinch", "keyMapping", "minZoom", "maxZoom", "enableBoundingBox", "boundaryRatioVertical", "boundaryRatioHorizontal", "noStateUpdate", "onPanStart", "onPan", "onPanEnd", "onZoom", "onZoomEnd", "preventPan", "style", "onDoubleClick", "onMouseDown", "onKeyDown", "onKeyUp", "onTouchStart", "onStateChange"]);
